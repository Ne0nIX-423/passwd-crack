...
print("101010010101010101010PassCrack010101010101010101010")
print("-_-_-_-_-_-/PASS|Crack\-_-_-_-_-_-")
print("")
print("!__Program by Neonix__!")
...
class PassGen:
    ...
    def generator(self, ignore_additional = True):
        ...
        print("vk:https://vk.com/neonhacker0987")
        print("vk neonixsa:vk.com/neonixvk")
        quit()
